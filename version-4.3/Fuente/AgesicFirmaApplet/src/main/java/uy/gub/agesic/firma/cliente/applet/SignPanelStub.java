 ...
 */
public class SignPanelStub extends javax.swing.JPanel {
     ...
     */
    public SignPanelStub(SignAppletStub viewer) {
        this.viewer = viewer;
    ...
    private void jButtonFirmarActionPerformed(java.awt.event.ActionEvent evt) {                                              
        ...
        SignBackgroundWorkerStub worker = new SignBackgroundWorkerStub(cert, pass, this.viewer.getDocumentos(), this.viewer.getTipoDocumentos(), this.viewer.getUserData(), this.viewer.getIdTransaccion(), this.viewer.isUsuarioDocumentoFirmado(), this.viewer.getOpciones(), this, buttonGroup3.getSelection().getActionCommand());
        worker.execute();
    ...
    public void displayPopupEtokenModel() {
        ...
        String ligACSCryptoMate = util.loadETokenLib(Constantes.MODELO_ACSCryptoMate, userAgent);
        ligACSCryptoMate = ((ligACSCryptoMate != null) && (ligACSCryptoMate.length() != 0)) ? " (" + ligACSCryptoMate + ")" : "";

        
        String empty = "---------";
        Object[] models = {empty, Constantes.MODELO_ALADDIN + ligAladdin, Constantes.MODELO_EPASS2003 + ligEPass2003, Constantes.MODELO_EPASS3003AUTO + ligEPass3003auto, "Cedula" + ligGemalto,"Abitab" +ligACSCryptoMate, Constantes.MODELO_OTRO};
    ...
    private void jButtonCargarCertificadosActionPerformed(java.awt.event.ActionEvent evt) {                                                          
        jComboBoxCertificados.removeAllItems();
        displayErrorMessage("");
    ...
    private void jRadioButtonTokenActionPerformed(java.awt.event.ActionEvent evt) {                                                  
    ...
    private void jRadioButtonArchivoActionPerformed(java.awt.event.ActionEvent evt) {                                                    
    ...
    private void jRadioButtonNavegadorActionPerformed(java.awt.event.ActionEvent evt) {                                                      
