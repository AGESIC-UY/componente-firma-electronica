 ...
 */
public class SignAppletStub extends JApplet implements AppletStub {
...
//    private SwingController controller;
    ...
    SignPanelStub signPdfPanel = null;
...
//                    ErrorDialog.showMessageDialog(getContentPane(), "Piso la opcion:"+key+" con:"+keyValue);
                }
            } catch (Exception w) {
    ...
    private void botonFirmarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        signPdfPanel = new SignPanelStub(this);
...
//            con.setRequestMethod("POST");
    ...
    public static void main(String args[]) {
        logger.log(Level.INFO, "Main SignAppletStub....");
        
        //Carga los argumentos en params.
        ParametersUtils.setJNLPParametes(args, params);

        final SignAppletStub sas = new SignAppletStub();
        sas.init();
        sas.start();

        JFrame frameFirma = new JFrame("Digital Sign");

        frameFirma.addWindowListener(new WindowAdapter() {
            @Override
        ...
        frameFirma.setContentPane(sas);
        frameFirma.setMinimumSize(new Dimension(600, 500));
        frameFirma.setMaximumSize(new Dimension(900, 700));
        frameFirma.setVisible(true);
    }
}
