...
public class SignBackgroundWorker extends SwingWorker {
    ...
    public SignBackgroundWorker(SofisCertificate cert, String pass, File[] documentosToSign, String tipoDocumentos, String userData, String idTransaccion, boolean usuarioDocumentoFirmado, HashMap opciones, SignPanel parent, String typeProvider) {
        this.parent = parent;
        this.cert = cert;
        this.pass = pass;
